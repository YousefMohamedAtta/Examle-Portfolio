...
const Home = () => {
  ...
  const sendEmail = (e) => {
    ...
    e.preventDefault();
    emailjs.sendForm('service_gaehytn', 'template_038jv0t', form.current, 'HaZcOqpikFqUwBBFH')
      .then((result) => {
        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email:</span> yousefmohamedatta58@gmail.com</p>
                <p><span>Phone:</span> 01159532856</p>
                <p><span>Address:</span> 72 street AzizFahmy</p>
              </div>
            </Col>
